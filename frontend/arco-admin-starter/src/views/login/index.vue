                ...
                <div class="right">
                    <a-form :model="form" ref="formRef" layout="vertical" class="login-form" @submit="login">
                        ...
                        <a-form-item label="账号" field="username" :rules="[{ required: true, message: '请输入登录账号' }]">
                            <a-input v-model="form.username" placeholder="请输入登录账号，默认root" @press-enter="login"></a-input>
                        </a-form-item>
                        <a-form-item label="密码" field="password" :rules="[{ required: true, message: '请输入登录密码' }]">
                            <a-input-password v-model="form.password" placeholder="请输入登录密码，默认root123" @press-enter="login"></a-input-password>
                        </a-form-item>
                        <a-form-item>
